...
def get_latest_stoken():
    print("正在通过 Workers 获取最新 stoken...")
    try:
        ...
        if r.status_code == 200:
            ...
            if stoken:
                ...
                print("Workers 返回数据中无 stoken")
        else:
            print(f"Workers 请求失败: {r.status_code}")
    except Exception as e:
        print(f"获取 stoken 失败: {str(e)}")
    return None

STOKEN = get_latest_stoken() or os.getenv("QUARK_STOKEN")
if not STOKEN:
